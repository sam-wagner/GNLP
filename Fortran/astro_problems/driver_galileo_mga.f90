...
DOUBLE_UPPER(1)=JF
!INITIAL TOF
DOUBLE_UPPER(2)=1500.D0
DOUBLE_UPPER(3)=1500.D0
DOUBLE_UPPER(4)=1500.D0
DOUBLE_UPPER(5)=1500.D0
DOUBLE_UPPER(6)=1500.D0
DOUBLE_UPPER(7)=1500.D0
DOUBLE_UPPER(8)=1500.D0
DOUBLE_UPPER(9)=1500.D0
!TOF OF FINAL LEG
DOUBLE_UPPER(10)=1500.D0
...
DO I=1,N_RUNS,1
    !THIS PART INCREASES MINIMUM NUMBER OF GRAVITY ASSISTS.  THE ALGORITHM TEND TO TRY AND CONVERGE EARLY ON SOLUTIONS WITH FEWER GRAVITY ASSISTS
    !COUNT1=COUNT1+1    
    !IF (COUNT1.GT. 10) THEN
    !    COUNT1=0
    !    INTEGER_LOWER(2)=INTEGER_LOWER(2)+1
    !END IF
...
CALL GNLP_DRIVER(IPRINT, N_POP, N_GEN, N_INT, N_DOUBLE, N1, N2, ITER_MAX_NLP, &
    ...
    OPEN(1,FILE='GENETIC_OUTPUT_GALILEO.TXT',ACCESS='APPEND')
