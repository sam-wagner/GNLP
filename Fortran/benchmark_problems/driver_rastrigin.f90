...
INTEGER :: SEED,  COUNT1, COUNT2, RATE, I, J, MIN_LOC, IPRINT
DOUBLE PRECISION :: TIME , FITNESS_INDV
...
CALL GENETIC_DRIVER(IPRINT, N_POP, N_GEN, N_INT, N_DOUBLE, N1, N2, ITER_MAX_NLP, &
    ...
    OPEN(1,FILE='GENETIC_OUTPUT_rastrigin_CONMIN.TXT',ACCESS='APPEND')
